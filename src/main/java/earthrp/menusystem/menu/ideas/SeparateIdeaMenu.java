...
//
//public class SeparateIdeaMenu extends Menu {
//    private final Earth earthPlugin;
//    int ideas;
//    double techMod;
//    public SeparateIdeaMenu(MenuUtility menuUtility, Earth earthPlugin){
//        super(menuUtility);
...
//    int ideaCost;
//
//    Material block = Material.WHITE_CONCRETE_POWDER;
//    String colorCode = "&f";
//
//    String idea11Name = "Separatism";
//    int idea1Id = 21;
//    ItemStack idea11;
//    ItemMeta idea11Meta;
//    List<@NotNull String> idea11Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a-50%&f к дани "));
//
//    String idea12Name = "Taxation with Representation";
//    int idea2Id = 22;
//    ItemStack idea12;
//    ItemMeta idea12Meta;
//    List<@NotNull String> idea12Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+10%&f доход от налогов")
//            );
//
...
//    ItemStack idea13;
//    ItemMeta idea13Meta;
//    List<@NotNull String> idea13Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&a+1&f к ПМА"));
//
//    String idea14Name = "Revanchism";
//    int idea4Id = 24;
//    ItemStack idea14;
//    ItemMeta idea14Meta;
//    List<@NotNull String> idea14Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&a+2&f реваншизма"));
//
//    String idea15Name = "Experienced Diplomats";
//    int idea5Id = 25;
//    ItemStack idea15;
//    ItemMeta idea15Meta;
//    List<@NotNull String> idea15Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+50% &fк согласию поддержать независисмость")
//    );
//
//
//
//    @Override
//    public String getMenuName() {return "Освободительные идеи";}
//
//    @Override
