...
//
//public class TradeIdeaMenu extends Menu {
//    private final Earth earthPlugin;
//    int ideas;
//    double techMod;
//    public TradeIdeaMenu(MenuUtility menuUtility, Earth earthPlugin) {
//        super(menuUtility);
...
//    int ideaCost;
//
//    Material block = Material.YELLOW_CONCRETE_POWDER;
//
//    String idea11Name = "Merchant Adventures";
//    int idea1Id = 11;
//    ItemStack idea11;
//    ItemMeta idea11Meta;
//    List<@NotNull String> idea11Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&ax2&f Бонус от количества товаров на рынке"));
//
//    String idea12Name = "Overseas Merchants";
//    int idea2Id = 12;
//    ItemStack idea12;
//    ItemMeta idea12Meta;
//    List<@NotNull String> idea12Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&aГТО&f при заключении"),
//            ChatColor.translateAlternateColorCodes('&',"&fторговых союзова &a+1")
//            );
//
//    String idea13Name = "National Trade Policy";
//    int idea3Id = 13;
//    ItemStack idea13;
//    ItemMeta idea13Meta;
//    List<@NotNull String> idea13Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&fПроизводство &a+0.1"));
//
//    String idea14Name = "Free Trade";
//    int idea4Id = 14;
//    ItemStack idea14;
//    ItemMeta idea14Meta;
//    List<@NotNull String> idea14Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&fЭффективность торговли &a+25%"));
//
//    String idea15Name = "Trade Manipulation";
//    int idea5Id = 15;
//    ItemStack idea15;
//    ItemMeta idea15Meta;
//    List<@NotNull String> idea15Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&fВозможность изменить"),
//            ChatColor.translateAlternateColorCodes('&',"&fглобальную цену &a1 товара")
//    );
//
//
//
//    @Override
//    public String getMenuName() {return "Торговые идеи";}
//
//    @Override
...
//        if (i==0){
//            idea11Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea11Name +" &b"+ideaCost+"&fૹ"));
//
//        }else {
//            idea11Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea11Name));
...
//        if (i==0){
//            idea12Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea12Name +" &b"+ideaCost+"&fૹ"));
//
//        }else {
//            idea12Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea12Name));
...
//        if (i==0){
//            idea13Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea13Name +" &b"+ideaCost+"&fૹ"));
//
//        }else {
//            idea13Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea13Name));
...
//        if (i==0){
//            idea14Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea14Name +" &b"+ideaCost+"&fૹ"));
//
//        }else {
//            idea14Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea14Name));
...
//        if (i==0){
//            idea15Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea15Name +" &b"+ideaCost+"&fૹ"));
//
//        }else {
//            idea15Meta.setDisplayName(ChatColor.translateAlternateColorCodes('&',"&e"+ idea15Name));
