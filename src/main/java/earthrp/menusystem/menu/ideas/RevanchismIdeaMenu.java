...
//
//public class RevanchismIdeaMenu extends Menu {
//    private final Earth earthPlugin;
//    int ideas;
//    double techMod;
//    public RevanchismIdeaMenu(MenuUtility menuUtility, Earth earthPlugin) {
//        super(menuUtility);
//        this.earthPlugin = earthPlugin;
//        ideas = this.earthPlugin.getServerDatabase().getPlayerTech(uuid,41);
//        techMod = 1;
//        ideaCost = (int) ( Math.floor((10 + 10) * techMod));
//    }
//    Player p = this.menuUtility.getOwner();
//    UUID uuid = p.getUniqueId();
//    int ideaCost;
//
//    Material block = Material.BROWN_CONCRETE_POWDER;
//    String colorCode = "&4";
//
//    String idea11Name = "Revanchism 1";
//    int idea1Id = 31;
//    ItemStack idea11;
//    ItemMeta idea11Meta;
//    List<@NotNull String> idea11Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&fБонусы от реваншизма удваиваются"));
//
//    String idea12Name = "Revanchism 2";
//    int idea2Id = 32;
//    ItemStack idea12;
//    ItemMeta idea12Meta;
//    List<@NotNull String> idea12Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+20&f к максимуму &2MP")
//            );
//
//    String idea13Name = "Revanchism 3";
//    int idea3Id = 33;
//    ItemStack idea13;
//    ItemMeta idea13Meta;
//    List<@NotNull String> idea13Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&a-50%&f Стоимость строительства военных зданий"));
//
//    String idea14Name = "Revanchism 4";
//    int idea4Id = 34;
//    ItemStack idea14;
//    ItemMeta idea14Meta;
//    List<@NotNull String> idea14Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a-20%&f содержание войск"),
//            ChatColor.translateAlternateColorCodes('&',"&a+20%&f доход от налогов"));
//
//    String idea15Name = "Revanchism 5";
//    int idea5Id = 35;
//    ItemStack idea15;
//    ItemMeta idea15Meta;
//    List<@NotNull String> idea15Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a-50%&f стоимость строительства"),
//            ChatColor.translateAlternateColorCodes('&',"&ax2&f получение военных традиций")
//    );
//
//
//
//    @Override
//    public String getMenuName() {return "Реваншистские идеи";}
//
//    @Override
