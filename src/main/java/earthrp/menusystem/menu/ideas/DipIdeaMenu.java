...
//
//public class DipIdeaMenu extends Menu {
//    private final Earth earthPlugin;
//    int ideas;
//    double techMod;
//    public DipIdeaMenu(MenuUtility menuUtility, Earth earthPlugin){
//        super(menuUtility);
...
//    int ideaCost;
//
//    Material block = Material.CYAN_CONCRETE_POWDER;
//    String colorCode = "&3";
//
...
//            ChatColor.translateAlternateColorCodes('&',"&a+3&f ПМА"));
//
//    String idea12Name = "Benign Diplomats";
//    int idea2Id = 17;
//    ItemStack idea12;
//    ItemMeta idea12Meta;
//    List<@NotNull String> idea12Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+25%&f к улучшению отношений")
//            );
//
...
//    ItemStack idea13;
//    ItemMeta idea13Meta;
//    List<@NotNull String> idea13Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&fАдминистративная эффективность &a+2"));
//
//    String idea14Name = "Cabinet";
//    int idea4Id = 19;
//    ItemStack idea14;
//    ItemMeta idea14Meta;
//    List<@NotNull String> idea14Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&fТелепорты в посольствах"));
//
//    String idea15Name = "Flexible Negotiations";
//    int idea5Id = 20;
//    ItemStack idea15;
//    ItemMeta idea15Meta;
//    List<@NotNull String> idea15Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&fДлительность перемирия после войны сокращена до 1 дня")
//    );
//
//
//
//    @Override
//    public String getMenuName() {return "Дипломатические идеи";}
//
//    @Override
...
//                new DipIdeaMenu(menuUtility, this.earthPlugin).open();
