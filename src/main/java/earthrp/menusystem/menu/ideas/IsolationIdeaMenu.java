...
//
//public class IsolationIdeaMenu extends Menu {
//    private final Earth earthPlugin;
//    int ideas;
//    double techMod;
//    public IsolationIdeaMenu(MenuUtility menuUtility, Earth earthPlugin)  {
//        super(menuUtility);
//        this.earthPlugin = earthPlugin;
//        ideas = this.earthPlugin.getServerDatabase().getPlayerTech(uuid,41);
//        techMod = 1;
//        ideaCost = (int) ( Math.floor(10 * techMod));
//    }
//    Player p = this.menuUtility.getOwner();
//    UUID uuid = p.getUniqueId();
//    int ideaCost;
//
//    Material block = Material.PINK_CONCRETE_POWDER;
//    String colorCode = "&d";
//
//    String idea11Name = "Isolation 1";
//    int idea1Id = 31;
//    ItemStack idea11;
//    ItemMeta idea11Meta;
//    List<@NotNull String> idea11Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a-50%&fСтоимость повышения стабильности"));
//
//    String idea12Name = "Isolation 2";
//    int idea2Id = 32;
//    ItemStack idea12;
//    ItemMeta idea12Meta;
//    List<@NotNull String> idea12Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+15%&f сопротивление урону в фазе &6Шока")
//            );
//
//    String idea13Name = "Isolation 3";
//    int idea3Id = 33;
//    ItemStack idea13;
//    ItemMeta idea13Meta;
//    List<@NotNull String> idea13Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a-1&f$ спад стабильности"));
//
...
//            ChatColor.translateAlternateColorCodes('&',"&a+100%&f к приросту полит власти")
//    );
//
//    String idea15Name = "Isolation 5";
//    int idea5Id = 35;
//    ItemStack idea15;
//    ItemMeta idea15Meta;
//    List<@NotNull String> idea15Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+0.2&fк производству везде")
//    );
//
//
//
//    @Override
//    public String getMenuName() {return "Изоляционнистские идеи";}
//
//    @Override
