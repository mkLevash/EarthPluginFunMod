...
//
//public class ImperialIdeaMenu extends Menu {
//    private final Earth earthPlugin;
//    int ideas;
//    double techMod;
//    public ImperialIdeaMenu(MenuUtility menuUtility, Earth earthPlugin)  {
//        super(menuUtility);
...
//    int ideaCost;
//
//    Material block = Material.BLACK_CONCRETE_POWDER;
//    String colorCode = "&7";
//
//    String idea11Name = "Experienced Diplomats";
//    int idea1Id = 16;
//    ItemStack idea11;
//    ItemMeta idea11Meta;
//    List<@NotNull String> idea11Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+1&f ПМА"));
//
//    String idea12Name = "Adaptability";
//    int idea2Id = 17;
//    ItemStack idea12;
//    ItemMeta idea12Meta;
//    List<@NotNull String> idea12Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a-50%&f стоимость национализации")
//            );
//
//    String idea13Name = "Diplomatic Corps";
//    int idea3Id = 18;
//    ItemStack idea13;
//    ItemMeta idea13Meta;
//    List<@NotNull String> idea13Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&a-50%&f к нужным очкам влияния"));
//
//    String idea14Name = "State Propaganda";
//    int idea4Id = 19;
//    ItemStack idea14;
//    ItemMeta idea14Meta;
//    List<@NotNull String> idea14Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&fУбирается штраф за разрыв мира, но он это стоит &c1&f£"));
//
//    String idea15Name = "Grand Army";
//    int idea5Id = 20;
//    ItemStack idea15;
//    ItemMeta idea15Meta;
//    List<@NotNull String> idea15Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+25% &fк морали вам и вашим вассалам")
//    );
//
//
//
//    @Override
//    public String getMenuName() {return "Империалистические идеи";}
//
//    @Override
...
//                new ImperialIdeaMenu(menuUtility, this.earthPlugin).open();
