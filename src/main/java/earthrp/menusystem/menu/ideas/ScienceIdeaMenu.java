...
//
//public class ScienceIdeaMenu extends Menu {
//    private final Earth earthPlugin;
//    int ideas;
//    double techMod;
//    public ScienceIdeaMenu(MenuUtility menuUtility, Earth earthPlugin)  {
//        super(menuUtility);
...
//    int ideaCost;
//
//    Material block = Material.LIGHT_BLUE_CONCRETE_POWDER;
//    String colorCode = "&b";
//
//    String idea11Name = "Science 1";
//    int idea1Id = 26;
//    ItemStack idea11;
//    ItemMeta idea11Meta;
//    List<@NotNull String> idea11Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&fИсследуйте 1 технологию"));
//
//    String idea12Name = "Science 2";
//    int idea2Id = 27;
//    ItemStack idea12;
//    ItemMeta idea12Meta;
//    List<@NotNull String> idea12Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+1&f прирост ОИ")
//            );
//
//    String idea13Name = "Science 3";
//    int idea3Id = 28;
//    ItemStack idea13;
//    ItemMeta idea13Meta;
//    List<@NotNull String> idea13Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&a-10%&f Стоимость строительства науч зданий"));
//
//    String idea14Name = "Science 4";
//    int idea4Id = 29;
//    ItemStack idea14;
//    ItemMeta idea14Meta;
//    List<@NotNull String> idea14Desc = List.of(ChatColor.translateAlternateColorCodes('&',"&a-10%&f стоимость технологий"));
//
//    String idea15Name = "Science 5";
//    int idea5Id = 30;
//    ItemStack idea15;
//    ItemMeta idea15Meta;
//    List<@NotNull String> idea15Desc = List.of(
//            ChatColor.translateAlternateColorCodes('&',"&a+0.5&f прирост ОИ от науч зданий")
//    );
//
//
//
//    @Override
//    public String getMenuName() {return "Научные идеи";}
//
//    @Override
