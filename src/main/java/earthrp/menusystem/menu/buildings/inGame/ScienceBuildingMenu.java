...
public class ScienceBuildingMenu extends Menu {
    ...
    public ScienceBuildingMenu(MenuUtility menuUtility) {
        super(menuUtility);
        if(b.getData().getType().equals(BuildingType.UNIVERSITY)){
            oiIncome = Earth.getInstance().getConfig().getInt("universityIncome");
        } else if (b.getData().getType().equals(BuildingType.LIBRARY)) {
    ...
    public void setMenuItems() {
        ...
        ItemStack market;
        ItemMeta marketMeta;
        market = new ItemStack(Material.WRITABLE_BOOK, 1);
