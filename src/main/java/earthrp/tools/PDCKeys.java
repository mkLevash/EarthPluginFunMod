...
public class PDCKeys {
    ...
    public final static NamespacedKey holoKey = new NamespacedKey(Earth.getInstance(), "holoType");
    public final static NamespacedKey techIdKey = new NamespacedKey(Earth.getInstance(), "techId");
    public final static NamespacedKey techStatusKey = new NamespacedKey(Earth.getInstance(), "techStatus");
    public final static NamespacedKey techCheckKey = new NamespacedKey(Earth.getInstance(), "techCheck");
    public final static NamespacedKey techCostKey = new NamespacedKey(Earth.getInstance(), "techCost");
    public final static NamespacedKey statIdKey = new NamespacedKey(Earth.getInstance(), "statId");
    ...
    public final static NamespacedKey unitDiscKey = new NamespacedKey(Earth.getInstance(),"unitDisc");
    ...
    public final static NamespacedKey buildingCostKey = new NamespacedKey(Earth.getInstance(),"buildingCost");
    public final static NamespacedKey buildingTechCheckKey = new NamespacedKey(Earth.getInstance(),"buildingTechCheck");
